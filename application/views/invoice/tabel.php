	...
	<div class="container-fluid">
		...
		<div class="row mb-2">
			...
			<div class="col-sm-6">
				...
				<a target="_blank" href="<?= base_url("Produk/laporan_perjam?tgl1=$tgl1&tgl2=$tgl2") ?>" class="btn btn-success mr-2 float-right"><i class="fas fa-print"></i> Laporan Perjam</a>
