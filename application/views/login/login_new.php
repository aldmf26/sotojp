...
<head>
    ...
    <style>
        ...
        body {
            background: #fed53b;
            background: linear-gradient(to right, #fed53b, #fed53b);
        }
        ...
        <div class="row">
            <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    <div class="card-body">
                        <h5 class="card-title text-center" style="font-weight: bold; color: #787878;">Login Soto JP</h5>
