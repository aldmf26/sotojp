...
<aside class="main-sidebar sidebar-light-pink elevation-4">
  <!-- Brand Logo -->
  <a href="" class="brand-link" style=" background:#fed53b ; color: #787878;">
    <img src="<?= base_url('asset/img/');  ?>logo_fix.png" alt="Soto JP Product" class="brand-image img-circle elevation-3" style="opacity: .8">
    <span class="brand-text font-weight-light">SOTO JP</span>
  </a>
